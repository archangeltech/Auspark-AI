  ...
  return (
    <div className="fixed inset-0 z-[9999] grid place-items-center p-4">
      ...
      <div className="relative bg-white w-full max-w-md rounded-[32px] overflow-hidden shadow-2xl animate-fade-in flex flex-col pointer-events-auto">
        ...
        <div className="p-6 bg-slate-50 border-t border-slate-100 text-center"><p className="text-[10px] font-black uppercase text-slate-400">Parking Sign Reader v1.4.2</p></div>
      </div>
    </div>
  );
};
